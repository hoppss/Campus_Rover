...
namespace autolabor_rviz_tools
{
  ...
  {
    setIcon( rviz::loadPixmap("package://ui_tools/icons/ClickPoint.png") );
    pub_ = nh_.advertise<geometry_msgs::PointStamped>( "/autolabor_points", 1 );
  }
...
PLUGINLIB_EXPORT_CLASS(autolabor_rviz_tools::ClickPointTool, rviz::Tool )
