...
{
  n_private.param<int>("joy_mode_button", joy_mode_button_, 1.0);
  n_private.param<int>("nav_mode_button", nav_mode_button_, 1.0);
  n_private.param<int>("stop_mode_button", stop_mode_button_, 1.0);
  n_private.param<int>("release_mode_button", release_mode_button_, 1.0);
...
{
  ros::init(argc, argv, "luke_cmd_vel_mux");
  ros::NodeHandle nh;
