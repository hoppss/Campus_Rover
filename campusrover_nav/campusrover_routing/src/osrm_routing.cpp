#include <campusrover_routing/osrm_routing.hpp>
...
void OsrmRouting::updateCampusroverGpsLocationCallback(const sensor_msgs::NavSatFix::ConstPtr& msg)
{
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber gps_goal_sub = n.subscribe("/campusrover_gps_destination", 10,
                                &OsrmRouting::gpsDestinationCallback, &osrm_routing);
  ros::Subscriber campusrover_gps_sub = n.subscribe("/campusrover_gps_location", 10,
                                &OsrmRouting::updateCampusroverGpsLocationCallback, &osrm_routing);
