...
#include <autolabor_msgs/ArmAction.h>
...
void callService(ros::ServiceClient &client,autolabor_msgs::ArmAction &srv) ;
...
{
    static autolabor_msgs::ArmAction pose_srv;
...
int main(int argc, char **argv)
{
    ...
    arm_srv_client_ = n.serviceClient<autolabor_msgs::ArmAction>("arm_action");
    spinner.start();
    ros::waitForShutdown();
    return 0;
}