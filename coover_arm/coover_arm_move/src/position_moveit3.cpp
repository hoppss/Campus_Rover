...
int main(int argc, char** argv)
{
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("link_0");
  ...
  //std::copy(move_group.getRobotModel().getJointModelGroupNames().begin(), move_group.getRobotModel().getJointModelGroupNames().end(),
  ...
  double press_dis = 0.05;

  target_pose3.position.z -= 0.05;
  waypoints.push_back(target_pose3);  // down

  target_pose3.position.x += press_dis*cos(yaw);
  target_pose3.position.y += press_dis*sin(yaw);
