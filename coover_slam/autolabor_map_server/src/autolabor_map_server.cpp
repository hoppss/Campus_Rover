#include <autolabor_map_server/autolabor_map_server.h>
...
void connect_database()
{
  try
  {
    ...
    sql_con_ = sql_driver_->connect("tcp://127.0.0.1:3306", "root", "autolabor");
    sql_con_->setSchema("autolabor_database");
  }
  catch (sql::SQLException &e)
  {
    cout << "# ERR: SQLException in " << __FILE__;
...
{
  ros::init(argc, argv, "autolabor_map_server");
  ros::NodeHandle n;
  ros::NodeHandle nh_private("~");
  connect_database();
  std::string fname("/home/justin/autolabor_ws/src/autolabor_summer_demo_2017/autolabor_map_server/maps/mit/media_lab_yard.yaml");
