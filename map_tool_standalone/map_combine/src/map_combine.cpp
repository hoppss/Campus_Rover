...
main (int argc, char **argv)
{
    ...
    while (nh.ok())
    {
        ...
        sprintf(cstr[0],"/home/eric/Desktop/map2/%s",(floors + "/" +str[0]).c_str());
        sprintf(cstr[1],"/home/eric/Desktop/map2/%s",(floors + "/" +str[1]).c_str());
        sprintf(cstr[2],"/home/eric/Desktop/map2/%s",(floors + "/" +str[2]).c_str());
        sprintf(cstr[3],"/home/eric/Desktop/map2/%s",(floors + "/" +str[3]).c_str());
        sprintf(cstr[4],"/home/eric/Desktop/map2/%s",(floors + "/" +str[4]).c_str());
        sprintf(cstr[5],"/home/eric/Desktop/map2/%s",(floors + "/" +str[5]).c_str());
        sprintf(cstr[6],"/home/eric/Desktop/map2/%s",(floors + "/" +str[6]).c_str());
        sprintf(cstr[7],"/home/eric/Desktop/map2/%s",(floors + "/" +str[7]).c_str());
        sprintf(cstr[8],"/home/eric/Desktop/map2/%s",(floors + "/" +str[8]).c_str());
